...
<head>
    ...
    <script type="text/javascript">
        ...
        function doUrl(){
            ...
            window.location.href = "${contextPath}/notice/view?agentId="+agentId+"&sendTime="+sendTime+"&pageSize="+pageSize+"&_csrf=${_csrf}";
        }
...
<section id="content" class="container">
    ...
    <div class="block-area" id="defaultStyle">
        ...
        <table class="table tile textured">
            ...
            <c:forEach var="log" items="${pageBean.result}" varStatus="index">
                <tr>
                    ...
                    <td>
                        <center>
                            <a href="${contextPath}/notice/detail?logId=${log.logId}&_csrf=${_csrf}" title="查看详情">
        ...
        <cron:pager href="${contextPath}/notice/view?agentId=${agentId}&sendTime=${sendTime}&_csrf=${_csrf}" id="${pageBean.pageNo}" size="${pageBean.pageSize}" total="${pageBean.totalCount}"/>
