...
import static com.jcronjob.common.utils.CommandUtils.executeShell;
...
public class AgentMonitor {
    ...
    public void start(final int port) throws Exception {
        ...
        server.addConnectListener(new ConnectListener() {//添加客户端连接监听器
            ...
            public void onConnect(final SocketIOClient client) {
                ...
                logger.info("[cronjob]:monitor connected:SessionId @ {},port @ {}", sessionId, port);
    ...
    public  Monitor monitor() {
        ...
        try {
            ...
            String monitorString = executeShell(Globals.CRONJOB_MONITOR_SHELL);
