...
import com.jcronjob.service.ExecuteService;
...
public class VerifyController {
    ...
    public void validatePing(int proxy, Long proxyId, String ip, Integer port, String password, HttpServletResponse response) {
        ...
        if (proxy == Cronjob.ConnType.PROXY.getType()) {
            agent.setProxy(Cronjob.ConnType.CONN.getType());
            if (proxyId != null) {
                ...
                //需要代理..
                agent.setProxy(Cronjob.ConnType.PROXY.getType());
            }
        }
