...
<head>
    ...
    $(document).ready(function(){
        $("#size").change(function(){
            ...
            window.location.href = "/worker/view?pageSize="+pageSize;
        });
    ...
    function pingCheck(){
        ...
        $("#pingResult").html("<img src='/img/icon-loader.gif'> <font color='#2fa4e7'>检测中...</font>");
    ...
    <div class="block-area" id="defaultStyle">
        <div>
            ...
            <div style="float: right;margin-top: -10px">
                <a href="/worker/addpage" class="btn btn-sm m-t-10" style="margin-left: 50px;margin-bottom: 8px"><i class="icon">&#61943;</i>添加</a>
            </div>
            </c:if>
        </div>
                    ...
                    <td>
                        <center>
                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                ...
                                <a href="/job/addpage?id=${w.workerId}" title="新任务">
                                ...
                                <a href="/worker/detail?id=${w.workerId}" title="查看详情">
        ...
        <ben:pager href="/worker/view" id="${page.pageNo}" size="${page.pageSize}" total="${page.totalCount}"/>
