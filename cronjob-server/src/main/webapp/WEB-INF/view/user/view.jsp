    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $("#size").change(function(){
                ...
                window.location.href = "/user/view?pageSize="+pageSize;
            });
...
<section id="content" class="container">
    ...
    <div class="block-area" id="defaultStyle">
        ...
        <div style="float: right;margin-top: -10px">
            <a href="/user/addpage" class="btn btn-sm m-t-10" style="margin-left: 50px;margin-bottom: 8px"><i class="icon">&#61943;</i>添加</a>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <center>
                            ...
                            <a href="/user/editpage?id=${u.userId}" title="编辑资料">
                                <i class="glyphicon glyphicon-pencil"></i>
                            </a>&nbsp;&nbsp;
                            <a href="/user/self?id=${u.userId}" title="查看详情">
        ...
        <ben:pager href="/user/view" id="${page.pageNo}" size="${page.pageSize}" total="${page.totalCount}"/>
