    ...
    <div class="block-area" id="defaultStyle">
        ...
        <table class="table tile">
            ...
            <c:forEach var="r" items="${page.result}" varStatus="index">
                <tr>
                    <td><a href="/job/detail?id=${r.jobId}">${r.jobName}</a></td>
        ...
        <ben:pager href="/record/running?queryTime=${queryTime}&workerId=${workerId}&jobId=${jobId}&execType=${execType}" id="${page.pageNo}" size="${page.pageSize}" total="${page.totalCount}"/>
