    ...
    <div class="block-area" id="defaultStyle">
        ...
        <table class="table tile">
            ...
            <tr>
                ...
                <td><a href="/job/detail?id=${record.jobId}">${record.jobName}</a></td>
            ...
            <tr>
                ...
                <td><a href="/worker/detail?id=${record.workerId}">${record.workerName}</a></td>

                <td><i class="glyphicon glyphicon-user"></i>&nbsp;任&nbsp;&nbsp;务&nbsp;&nbsp;人</td>
                <td>
                    <c:if test="${permission eq true}"><a href="/user/self?id=${record.operateId}">${record.operateUname}</a></c:if>
            ...
            <tr>
                <td colspan="4">
                    ...
                    <pre id="pre" style="font-size:12px;color:#FFF;border: none;background: none;white-space: pre-wrap;word-wrap: break-word;">${record.message}</pre>
                </td>
            </tr>
            </tbody>
