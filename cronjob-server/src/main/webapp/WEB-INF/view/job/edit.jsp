    ...
    <script type="text/javascript">
        ...
        function saveSubJob() {
            ...
            if (redo == 1){
                ...
                if(!cronjob.testNumber($("#runCount1").val())){
                    alert("截止重跑次数必须为正整数!");
                    return false;
                }
            }
        ...
        <div class="tile p-15">
            <form class="form-horizontal" role="form" id="job" action="/job/save" method="post"><br>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <textarea class="form-control input-sm" id="command" name="command">${job.command}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <textarea class="form-control input-sm" id="comment" name="comment">${job.comment}</textarea>
                    </div>
                </div><br>
