...
<head>
    ...
    <script type="text/javascript">
        ...
        function doUrl(){
            ...
            window.location.href = "/notice/view?workerId="+workerId+"&sendTime="+sendTime+"&pageSize="+pageSize;
        }
    ...
    <div class="block-area" id="defaultStyle">
        ...
        <div>
            ...
            <div style="float: right;margin-top: -10px">
                ...
                <input type="text" id="sendTime" name="sendTime" value="${sendTime}" onfocus="WdatePicker({onpicked:function(){doUrl(); },dateFmt:'yyyy-MM-dd'})" class="Wdate select-self" style="width: 100px"/>
        ...
        <table class="table tile">
            ...
            <c:forEach var="log" items="${page.result}" varStatus="index">
                <tr>
                    ...
                    <td>
                        <center>
                            <a href="/notice/detail?logId=${log.logId}" title="查看详情">
        ...
        <ben:pager href="/notice/view?workerId=${workerId}&sendTime=${sendTime}" id="${page.pageNo}" size="${page.pageSize}" total="${page.totalCount}"/>
